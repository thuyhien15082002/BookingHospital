...
<header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
        ...
        <nav id="navbar" class="navbar order-last order-lg-0">
            <ul>
                <c:if test="${not empty user or empty user and empty doctor}">
                    <li><a class="nav-link scrollto" href="web-home">Trang chủ</a></li>
                </c:if>
                <c:if test="${not empty doctor }">
                    <li><a class="nav-link scrollto" href="doctor-home">Trang chủ</a></li>
                </c:if>
                ...
                <c:if test="${empty user and empty doctor}">
                ...
                <c:if test="${not empty doctor}">
                    <li class="dropdown"><a href="#"><span>Bs. ${doctor.getName()}</span><i class="bi bi-chevron-down"></i></a>
                        <ul>
<%--                            <li><a href="profile">Thông tin tài khoản</a></li>--%>
                            <li><a href="log-out">Đăng xuất</a></li>
                        </ul>
